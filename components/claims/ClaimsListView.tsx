    ...
    <div className="p-6 space-y-4">
      ...
      <div className="flex flex-wrap gap-3 items-center justify-between">
        ...
        <Link href="/claims/new">
          <Button className="bg-[#5B3FD4] hover:bg-[#4a33b0]">
            ...
            {loading ? (
              ...
              <tr>
                <td colSpan={8} className="px-4 py-12 text-center text-gray-500">
                  No claims found.{' '}
                  <Link href="/claims/new" className="text-[#5B3FD4] hover:underline">
                ...
                <tr key={claim.id} className="border-b border-gray-50 hover:bg-gray-50 transition-colors">
                  ...
                  <td className="px-4 py-3">
                    <div className="flex gap-2">
                      ...
                      {!claim.riskLevel && (
                        <Link href={`/claims/${claim.id}`}>
                          <Button variant="ghost" size="sm" className="h-7 text-xs text-[#5B3FD4]">
